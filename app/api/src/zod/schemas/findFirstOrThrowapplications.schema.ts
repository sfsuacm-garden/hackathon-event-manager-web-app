...
export const applicationsFindFirstOrThrowSelectSchema: z.ZodType<Prisma.applicationsSelect> = z.object({
...
export const applicationsFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    event_id: z.boolean().optional(),
    user_id: z.boolean().optional(),
    status: z.boolean().optional(),
...
export const applicationsFindFirstOrThrowSchema: z.ZodType<Prisma.applicationsFindFirstOrThrowArgs> = z.object({ select: applicationsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => applicationsIncludeObjectSchema.optional()), orderBy: z.union([applicationsOrderByWithRelationInputObjectSchema, applicationsOrderByWithRelationInputObjectSchema.array()]).optional(), where: applicationsWhereInputObjectSchema.optional(), cursor: applicationsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([applicationsScalarFieldEnumSchema, applicationsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.applicationsFindFirstOrThrowArgs>;

export const applicationsFindFirstOrThrowZodSchema = z.object({ select: applicationsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => applicationsIncludeObjectSchema.optional()), orderBy: z.union([applicationsOrderByWithRelationInputObjectSchema, applicationsOrderByWithRelationInputObjectSchema.array()]).optional(), where: applicationsWhereInputObjectSchema.optional(), cursor: applicationsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([applicationsScalarFieldEnumSchema, applicationsScalarFieldEnumSchema.array()]).optional() }).strict();