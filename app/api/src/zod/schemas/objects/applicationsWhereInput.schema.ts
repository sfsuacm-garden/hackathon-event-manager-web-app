...
import { ProfilesNullableScalarRelationFilterObjectSchema } from './ProfilesNullableScalarRelationFilter.schema';
...
const makeSchema = (): z.ZodObject<any> => z.object({
  ...
  profiles: z.union([z.lazy(() => ProfilesNullableScalarRelationFilterObjectSchema), z.lazy(() => profilesWhereInputObjectSchema)]).nullish()
}).strict();
export const applicationsWhereInputObjectSchema: z.ZodType<Prisma.applicationsWhereInput> = makeSchema() as unknown as z.ZodType<Prisma.applicationsWhereInput>;
export const applicationsWhereInputObjectZodSchema = makeSchema();
