...
import { profilesCreateNestedOneWithoutApplicationsInputObjectSchema } from './profilesCreateNestedOneWithoutApplicationsInput.schema'
...
const makeSchema = (): z.ZodObject<any> => z.object({
  ...
  profiles: z.lazy(() => profilesCreateNestedOneWithoutApplicationsInputObjectSchema).optional()
}).strict();
export const applicationsCreateWithoutEventsInputObjectSchema: z.ZodType<Prisma.applicationsCreateWithoutEventsInput> = makeSchema() as unknown as z.ZodType<Prisma.applicationsCreateWithoutEventsInput>;
export const applicationsCreateWithoutEventsInputObjectZodSchema = makeSchema();
