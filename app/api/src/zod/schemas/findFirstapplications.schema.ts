...
export const applicationsFindFirstSelectSchema: z.ZodType<Prisma.applicationsSelect> = z.object({
...
export const applicationsFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    event_id: z.boolean().optional(),
    user_id: z.boolean().optional(),
    status: z.boolean().optional(),
...
export const applicationsFindFirstSchema: z.ZodType<Prisma.applicationsFindFirstArgs> = z.object({ select: applicationsFindFirstSelectSchema.optional(), include: z.lazy(() => applicationsIncludeObjectSchema.optional()), orderBy: z.union([applicationsOrderByWithRelationInputObjectSchema, applicationsOrderByWithRelationInputObjectSchema.array()]).optional(), where: applicationsWhereInputObjectSchema.optional(), cursor: applicationsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([applicationsScalarFieldEnumSchema, applicationsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.applicationsFindFirstArgs>;

export const applicationsFindFirstZodSchema = z.object({ select: applicationsFindFirstSelectSchema.optional(), include: z.lazy(() => applicationsIncludeObjectSchema.optional()), orderBy: z.union([applicationsOrderByWithRelationInputObjectSchema, applicationsOrderByWithRelationInputObjectSchema.array()]).optional(), where: applicationsWhereInputObjectSchema.optional(), cursor: applicationsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([applicationsScalarFieldEnumSchema, applicationsScalarFieldEnumSchema.array()]).optional() }).strict();