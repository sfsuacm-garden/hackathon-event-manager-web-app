import { joinTeam, createTeam  } from '../features/teams/teams.controller';
...
async function setTeamsTestUp(teamMemberCounts: number[]) {
  try {
...
async function cleanTeamsTestUp(setUpInfo: TeamTestSetupInfo) {
