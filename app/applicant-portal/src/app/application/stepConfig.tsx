...
export const steps: StepConfig<any>[] = [
  {
    ...
    fields: {
      ...
      levelOfStudy: {
        ...
        options: [
          { value: "Less than Secondary / High School", label: "Less than Secondary / High School" },
          ...
          { value: "Graduate University (Masters, Professional, Doctoral, etc)", label: "Graduate University (Masters, Professional, Doctoral, etc)" },
    ...
    fields: {
      ...
      dietaryGroup: {
        ...
        options: [
          ...
          { name: "Celiac Disease", label: "Celiac Disease" },
